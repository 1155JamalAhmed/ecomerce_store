...
const activeTabMapping = {
  ...
  "/shops/dashboard/refunds": 10,
  "/shops/dashboard/settings": 11,
};
...
const ShopDashboard = () => {
  ...
  return (
    <div className="grid grid-cols-[80px] 800px:grid-cols-[220px] repeat(11, 1fr)">
      ...
      <div className="col-span-11 overflow-hidden bg-white shadow rounded-[4px] p-3 my-0 400px:my-4 justify-self-center  w-[100%]  max-w-[780px] 400px:w-[80%]">
        <Outlet />
      </div>
    </div>
  );
